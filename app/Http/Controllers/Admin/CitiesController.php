...
class CitiesController extends Controller
{
    ...
    public function un_active($id) {
        ...
        return redirect($this->redirect)->with('error','تم  الغاء تفعيل المدينة بنجاح');
    ...
    public function active($id) {
        ...
        return redirect($this->redirect)->with('success','تم  تفعيل المدينة بنجاح');
        
    } 

    public function index()
    {
        $Item = Model::get(['name','id','governorate_id','status']);
    ...
    private function gteInput($request,$modelClass) {
        ...
        $input = $request->only(['name','governorate_id','shipping_value']);
