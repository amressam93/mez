...
@section('top_title') سياسة الاستخدام  @endsection

@section('main_title') سياسة الاستخدام  @endsection
   ...
   <div class="col-md-12">
      ...
      <div class="card card-custom gutter-b example example-compact">
         ...
         <div class="card-header">
            <h3 class="card-title">سياسة الاستخدام</h3>
         </div>


         <!--begin::Form-->
         {!! Form::open(['url' => "admin_panel/privacy", 'role'=>'form','id'=>'add', 'files' => true,'method'=>'post']) !!}
