...
@section('main_title') اضافه عرض جديد  @endsection
   ...
   <div class="col-md-12">
      ...
      <div class="card card-custom gutter-b example example-compact">
         ...
         <div class="card-header">
            <h3 class="card-title">اضافه عرض جديد </h3>
         </div>


         <!--begin::Form-->
         {!! Form::open(['url' => "admin_panel/top_offer", 'role'=>'form','id'=>'add', 'files' => true,'method'=>'post']) !!}
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 {{ $errors->has('color') ? ' has-error' : '' }}">
                        ...
                        <input type="color" name="color" class="form-control m-input" required="required" value="{{ old('color') }}" placeholder="  لون الخلفية ">
                    ...
                    <div class="col-sm-6 {{ $errors->has('link') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="link" class="form-control m-input" value="{{ old('link') }}" placeholder="  الرابط ">
