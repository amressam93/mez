...
<div class="row">
   ...
   <div class="col-md-12">
      ...
      <div class="card card-custom gutter-b example example-compact">
         ...
         <!--begin::Form-->
         {!! Form::open(['url' => "admin_panel/sub_categories", 'role'=>'form','id'=>'add', 'files' => true,'method'=>'post']) !!}
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 {{ $errors->has('sub_title') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="sub_title" class="form-control m-input" required="required" value="{{ old('sub_title') }}" placeholder=" اسم الشهره">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 {{ $errors->has('pic') ? ' has-error' : '' }}">
                        <label>  صوره المقاسات (400*300) <span class="text-danger">*</span> </label>
