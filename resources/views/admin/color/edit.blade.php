...
@section('main_title') تعديل لون  @endsection
...
<div class="row">
   ...
   <div class="col-md-12">
      ...
      <div class="card card-custom gutter-b example example-compact">
         ...
         <!--begin::Form-->
         {!! Form::model($Item, [ 'route' => ['admin_panel.color.update' , $Item->id ] , 'method' => 'patch', 'files' => true, 'role'=>'form','id'=>'edit' ]) !!}
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6 {{ $errors->has('title') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="title" class="form-control m-input" required="required" value="{{ $Item->title }}" placeholder=" اسم اللون ">
                    ...
                    <div class="col-sm-6 {{ $errors->has('value') ? ' has-error' : '' }}">
                        ...
                        <input class="form-control m-input" name="value" type="color" value="{{ $Item->value }}" placeholder="اللون" id="example-color-input">
                        @if ($errors->has('value'))
                            <span class="help-block" style="color:red">
