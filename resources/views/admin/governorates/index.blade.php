...
@section('sub_title') 
    ...
    <a href="{{ url('admin_panel/governorates/create') }}" class="btn btn-light-warning font-weight-bolder btn-sm">
        اضافه محافظه جديدة
    </a>
            ...
            <table class="table table-bordered table-checkable" id="m_table_1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('admin_panel/governorates/'). '/' . $value->id . '/edit'}}" class='m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill' title='Edit'>
        ...
        $(document).ready(function () {
            ...
            $('#m_table_1').on('click', '.un_active', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('admin_panel/governorates/un_active') }}' + '/' + ID;
            ...
            $('#m_table_1').on('click', '.active', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('admin_panel/governorates/active') }}' + '/' + ID;
