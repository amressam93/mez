        ...
        <div class="card-body">            
         ...
         <div class="user_content" style="margin-bottom:30px">
            ...
            <h3 style="margin-bottom:50px">
                <b style="border-bottom: 2px dashed #DDD;padding-bottom:10px">
                  تفاصيل الفاتوره
                </b>
            </h3>
            ...
            <label> <b>رقم التسلسل	</b> : {{ $invoice->serial_number }} </label>
            <label>&nbsp;,&nbsp;  <b>تاريخ الفاتوره	 	</b> : {{ $invoice->operation_date }} </label>
               ...
               <tbody>
                  ...
                  @if($Item->count() > 0)
                     ...
                     <tr>
                        ...
                        <td colspan="5"> {{ $invoice->coupon_value }} ج.م </td>
                     </tr>
